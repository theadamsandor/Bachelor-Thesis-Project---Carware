...
Class Users extends DBConnection {
	...
	public function save_users(){
		...
		if(empty($id)){
			...
			if($qry){
				...
				$this->settings->set_flashdata('success','A felhasználói adatok sikeresen frissítve.');
				foreach($_POST as $k => $v){
					if($k != 'id'){
						if(!empty($data)) $data .=" , ";
	...
	public function delete_users(){
		...
		if($qry){
			$this->settings->set_flashdata('success','A felhasználói adatokat sikeresen törölték.');
