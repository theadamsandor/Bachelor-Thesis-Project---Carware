...
<div class="card card-outline rounded-0 card-navy">
		...
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
				...
				<div class="form-group">
					...
					<input type="password" name="password" minlength="8" id="password" class="form-control" value="" autocomplete="off">
	...
	<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-lg btn-primary font-weight-bold" form="manage-user">Mentés</button>
				</div>
			</div>
		</div>
</div>
