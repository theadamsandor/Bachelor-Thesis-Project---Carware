...
<div class="card rounded-0 card-navy">
	<div class="bg_image card-header">
		<h3 class="display-4 text-light">Napi értékesítés jelentés</h3>
	</div>
	<div class="card-body">
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <button class="btn btn-light btn-lg col-lg-10 bg-gradient-light rounded-0 border" type="button" id="print"><i class="fa fa-print"></i> Nyomtatás</button>
                                </div>
                            </div>
                        </div>
                    </form>
			...
			<table class="table table-hover table-bordered">
				...
				<thead>
					<tr class="bg-lightblue">
						<th>#</th>
						<th>Dátum</th>
						<th>Munkalap azonosító/Ügyfél</th>
						<th>Termék neve</th>
						<th>Ár</th>
						<th>Mennyiség</th>
						<th>Összesen</th>
				...
				<tbody>
                    ...
                    $total = 0;
					$i = 1;
                    $qry = $conn->query("SELECT tp.*,tl.code, tl.client_name,pl.name as product,tl.date_created FROM `worksheet_products` tp inner join worksheet_list tl on tp.worksheet_id = tl.id inner join product_list pl on tp.product_id = pl.id where tl.status != 4 and date(tl.date_created) = '{$date}' order by unix_timestamp(tl.date_updated) asc ");
                ...
                <tfoot>
                    <th class="py-1 text-center" colspan="6">Összesen</th>
    ...
    <div class="d-flex w-100">
        ...
        <div class="col-8 text-center">
            <div style="line-height:1em">
                ...
                <h3 class="text-center mb-0"><b>Napi értékesítés jelentés</b></h3>
