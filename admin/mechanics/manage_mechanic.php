...
<div class="container-fluid">
	<form action="" id="mechanic-form">
		...
		<div class="form-group">
			<label for="firstname" class="control-label">Vezetéknév</label>
		...
		<div class="form-group">
			<label for="lastname" class="control-label">Keresztnév</label>
		...
		<div class="hidden">
			<label for="middlename" class="hidden"></label>
			<input type="hidden" name="middlename" id="middlename" class="form-control form-control-sm rounded-0" value="<?php echo isset($middlename) ? $middlename : ''; ?>"  placeholder="Opcionális"/>
		</div>
		<div class="form-group">
