...
<div class="container-fluid">
	<form action="" id="inventory-form">
		...
		<div class="form-group">
			<label for="quantity" class="control-label">Mennyiség</label>
		...
		<div class="form-group">
			<label for="stock_date" class="control-label">Bevételezés dátuma</label>
			<input type="date" name="stock_date" id="stock_date" class="form-control form-control-sm rounded-0 text-right" value="<?php echo isset($stock_date) ? date("Y-m-d") : ""; ?>" max="<?= date("Y-m-d") ?>"  required/>
		</div>
	</form>
</div>
<script>
